...
class FuzzyLocalization(Node):
    def __init__(self):
        ...
        self.declare_parameter("small_error", 0.40)
        self.declare_parameter("large_error", 0.55)
        ...
        self.declare_parameter("adaptive_error_enabled", False)
        ...
        self.declare_parameter("adaptive_deadband_ratio", 0.0)
        self.declare_parameter("velocity_error_source", "max")
