...
class ScriptedTrajectory(Node):
    ...
    The node follows a square using odometry feedback. It intentionally allows
    curved turns near corners, because the manual tests were car-like rather
    than exact stop-and-turn maneuvers.
    """
