...
class FuzzyLocalization(Node):
    def __init__(self):
        ...
        self.declare_parameter("slip_latch_hold_sec", 12.0)
        self.declare_parameter("slip_latch_ann_weight", 1.0)
    ...
    def timer_callback(self):
        ...
        slip_latch_alpha = self.slip_latch_alpha(fuzzy_input_error)
    ...
    def slip_latch_alpha(self, fuzzy_input_error):
        ...
        if self.slip_latch_active and now <= self.slip_latch_until:
            return self.clamp01(self.slip_latch_ann_weight)
        return 0.0
