#!/usr/bin/env python3
"""Apply FLS slip-latch tuning update.

Usage on Ubuntu:
    cd ~/bumperbot_ws/fls_slip_latch_update
    python3 apply_fls_slip_latch_update.py ~/bumperbot_ws/src
"""
...
def main() -> None:
    ...
    backup_root = patch_dir / f"backup_before_fls_slip_latch_update_{stamp}"
    backup_root.mkdir(parents=True, exist_ok=True)

    print("Applying FLS slip-latch update")
